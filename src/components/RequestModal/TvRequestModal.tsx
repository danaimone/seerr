                    ...
                    >
                      ...
                      >
                        <span
                          aria-hidden="true"
                          className={`${
                            isAllSeasons() ? 'bg-red-500' : 'bg-gray-800'
                        ...
                        <span
                          ...
                          } absolute left-0 inline-block h-5 w-5 rounded-full border border-gray-200 bg-white shadow transition-transform duration-200 ease-in-out group-focus:border-red-300 group-focus:ring`}
                        />
                      </span>
                    </th>
