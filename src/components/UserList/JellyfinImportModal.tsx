                        ...
                        <th className="w-16 bg-gray-500 px-4 py-3">
                          ...
                          >
                            ...
                            <span
                              ...
                              } absolute left-0 inline-block h-5 w-5 transform rounded-full border border-gray-200 bg-white shadow transition-transform duration-200 ease-in-out group-focus:border-red-300 group-focus:ring`}
                            />
                          </span>
                        </th>
