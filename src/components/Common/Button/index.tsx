...
function Button<P extends ElementTypes = 'button'>(
  ...
  switch (buttonType) {
    case 'primary':
      buttonStyle.push(
        'text-white border border-red-500 bg-red-600/80 hover:bg-red-600 hover:border-red-500 focus:border-red-700 focus:ring-red active:bg-red-600 active:border-red-700'
      );
      break;
    case 'danger':
      buttonStyle.push(
    ...
    default:
      buttonStyle.push(
        'text-gray-200 bg-gray-800/80 border-gray-600 hover:text-white hover:bg-gray-700 hover:border-gray-600 group-hover:text-white group-hover:bg-gray-700 group-hover:border-gray-600 focus:border-red-300 focus:ring-red active:text-gray-200 active:bg-gray-700 active:border-gray-600'
      );
  }
