    ...
    <Menu.Item>
      <a
        className={[
          ...
          buttonType === 'ghost'
            ? 'bg-transparent from-red-600 to-red-600 hover:bg-gradient-to-br focus:border-gray-500'
      ...
      <Menu.Button
        ...
        className={[
          ...
          buttonType === 'ghost'
            ...
            : `focus:ring-blue border-red-500 bg-red-600/80 hover:border-red-500 hover:bg-red-600 active:border-red-700 active:bg-red-700`,
          className,
        ].join(' ')}
        ref={buttonRef}
        disabled={!children}
